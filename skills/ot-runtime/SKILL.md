---
name: ot-runtime
description: Use for operating or troubleshooting the OneTool root runtime, transports, Direct API, readiness, reload, statistics, telemetry, logs, and stored results. Installation belongs to ot-setup; outbound MCP servers belong to ot-mcp-proxy.
user-invocable: true
---
