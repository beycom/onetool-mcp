# otpack-project-paths Specification

## Purpose

Defines the public `otpack` primitive for pack-owned project-local state paths
and excludes generic persistence helpers without an owned lifecycle contract.
