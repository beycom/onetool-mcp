# Worker Contexts Specification

## Purpose

Define project-local named Context persistence, metadata, lifecycle, privacy,
and mechanical episode History for the episodic worker runtime.
