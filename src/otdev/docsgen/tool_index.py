"""Generate the compact OneTool MCP Tool Index."""
...
def tool_inventory(
    *,
    ...
    """Load runtime pack/tool metadata for the Tool Index."""
    ...
    for pack_row in pack_rows:
        ...
        for detail in detail_rows:
            ...
            args = signature_args(str(detail.get("signature", "")))
            ...
            if include_tool_descriptions:
                tool_row["description"] = short_description(detail.get("description"))
            if include_descriptions:
                tool_row["arg_descriptions"] = description_by_arg(detail)
...
def format_text(
    ...
    *,
    ...
    """Render Tool Index Markdown from inventory rows."""
    lines: list[str] = []
...
def main(argv: list[str] | None = None) -> int:
    """Generate the Tool Index from the configured runtime registry."""
