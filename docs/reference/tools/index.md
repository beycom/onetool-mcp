...
| [**Display**](display.md) | core | In-process message producer for rich artifacts consumed by OneTool Console App. | 7 | MIT | `clear`, `focus`, `list`, `read`, `seed_mock_messages`, `show`, `status` |
