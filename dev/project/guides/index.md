...
Practical guides for building and configuring OneTool-specific features.
...
**Related:**
- [Architecture](../arch/index.md) - OneTool architecture and design
- [Testing](../../practices/testing.md) - Testing your tools
- [Logging](../../practices/logging.md) - LogSpan patterns for tools
