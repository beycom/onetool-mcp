...
| 9 | **Dual runtime: MCP + CLI** | Same loaded process from your agent *and* your shell/scripts/harnesses | `onetool direct run/repl/start`, discovery files, HTTP transport for containers |
